// main-script.js - Versão Completa com Controles de Reprodução e Transpose Integrado
...
// =============================================
// FUNÇÕES DE REGISTRO (MÚSICAS E TEXTOS)
// =============================================
...
function registerTextBlock(textData) {
  if (!textData || !textData.id || !textData.content) {
    console.error("Dados do texto inválidos:", textData);
    return;
  }
  elementsToRender.push({
    type: 'text',
...
function addTextBlock(htmlContent) {
