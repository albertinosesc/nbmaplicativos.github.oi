...
<html>
<head><meta charset="UTF-8"><title>Pro Maestro - App</title>
<script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"><\/script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/abcjs/6.2.2/abcjs-basic-min.js"><\/script>
<style>
    body { font-family: Arial; max-width: 1000px; margin: 0 auto; background: #f5f5f5; }
...
<script>
    ...
    function renderizarAula(container, conteudoOriginal) {
        ...
        container.innerHTML = marked.parse(processado);
    }
